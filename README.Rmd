...
- 2019-10-31: Version 4.0.0 is on Github (development version)
    - Fixed an error/issue [#6](https://github.com/gtatters/Thermimage/issues/6) in calculation of the atmospheric tau values, and added the option for the user to specify the 5 atmospheric constants (ATA1, ATA2, ATB1, ATB2, ATX) supplied in FLIR files.  Should not break earlier code, as the default constants can be assumed as in previous versions.  This update makes alterations to raw2temp, temp2raw, and flirsettings.
