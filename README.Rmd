...
2019-12-20: Version 4.1.0 is on Github (development version) - added the option to split thermal video files based on different filetype/header types.  See issue [#9](https://github.com/gtatters/Thermimage/issues/9). 
