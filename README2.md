...
```
    ...
    ## Installing package into '/Users/GlennTattersall/Documents/R/Library'
    ## (as 'lib' is unspecified)

    ## 
    ## The downloaded binary packages are in
    ##  /var/folders/0f/_hbgzdkx3pl6bvs35cm_dr1h0000gn/T//Rtmp0ze2Nh/downloaded_packages
...
```
    ...
    ##   '/private/var/folders/0f/_hbgzdkx3pl6bvs35cm_dr1h0000gn/T/Rtmp0ze2Nh/devtools12d9eb1c9f8b/gtatters-Thermimage-89f5fe2'  \
    ##   --library='/Users/GlennTattersall/Documents/R/Library' --install-tests
...
```
    ...
    ## exiftool '/Users/GlennTattersall/Desktop/SampleFLIR/SampleFLIR.jpg' -b -RawThermalImage | convert - gray:- | convert -depth 16 -endian lsb -size 640x480 gray:- '/Users/GlennTattersall/Desktop/SampleFLIR/output/SampleFLIR.png'
...
```
    ...
    ## 
    ## perl -f /Users/GlennTattersall/Documents/R/Library/Thermimage/perl/split_fff.pl 'SampleFLIR.csq'
    ## 
    ...
    ## 
    ## perl -f /Users/GlennTattersall/Documents/R/Library/Thermimage/perl/split_jpegls.pl temp/thermalvid.raw
    ## 
...
```
    ...
    ## 1 11.524041 17.614557 16.094052 377.6868 0.5 0.1     0 0.4 1 0.1 0.174
    ## 2 34.816017 38.712042 40.862705 499.7263 0.5 0.1     0 0.4 1 0.1 0.174
    ## 3 20.422126 25.127243 24.907190 370.6665 0.5 0.1     0 0.4 1 0.1 0.174
    ## 4 24.562264 29.492081 29.661912 421.4585 0.5 0.1     0 0.4 1 0.1 0.174
    ## 5  9.347308 15.102749 14.475261 423.7978 0.5 0.1     0 0.4 1 0.1 0.174
    ## 6  3.717473  9.001807  9.487975 476.9010 0.5 0.1     0 0.4 1 0.1 0.174
    ##       n a    b    m   type     shape
...
```
    ...
    ##  [1] 265.0316 390.6894 264.3903 310.1770 310.3259 363.6409 233.2663
    ##  [8] 279.7662 282.9688 301.4731 270.4730 280.6162 300.5056 320.8866
    ## [15] 286.6249 341.2079 287.8431 308.0739 349.7763 221.0473

``` r
(qconv.free.A<-with(d, qconv(Ts, Ta, V, L, c, n, a, b, m, type="free", shape)))
```

    ##  [1] -26.211097 -14.832856 -18.889549 -19.984929 -24.455344 -22.067289
    ##  [7] -18.588474 -13.005514 -25.268256 -18.886531 -24.986271 -22.466773
    ## [13] -19.788859 -18.080240 -22.852578 -20.247861 -14.544710  -6.763709
    ## [19] -10.813035 -18.577385

``` r
(qconv.forced.A<-with(d, qconv(Ts, Ta, V, L,  c, n, a, b, m, type, shape)))
```

    ##  [1] -63.22165 -39.34499 -48.27609 -50.33371 -59.92813 -55.49051 -47.61624
    ##  [8] -36.12136 -60.99439 -48.40347 -61.28565 -55.31078 -49.84372 -46.60946
    ## [15] -55.50666 -50.99232 -38.78636 -21.08763 -31.40868 -47.47570
...
```
    ...
    ## 1 0.618 1 0.58 0.25 forced hcylinder 106.0126 -25.28866  80.72399
    ## 2 0.618 1 0.58 0.25 forced hcylinder 156.2758 -15.73800 140.53776
    ## 3 0.618 1 0.58 0.25 forced hcylinder 105.7561 -19.31044  86.44567
    ## 4 0.618 1 0.58 0.25 forced hcylinder 124.0708 -20.13348 103.93731
    ## 5 0.618 1 0.58 0.25 forced hcylinder 124.1304 -23.97125 100.15911
    ## 6 0.618 1 0.58 0.25 forced hcylinder 145.4564 -22.19621 123.26017
...
![](README2_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-25-1.png)
...
![](README2_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-26-1.png)
...
![](README2_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-27-1.png)
...
![](README2_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-28-1.png)
